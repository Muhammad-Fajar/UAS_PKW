...
<body>
    <!--Navbar-->
    <nav class="navbar navbar-expand-lg navbar-dark shadow-sm" style="background-color: #5e60ce">
      <div class="container">
                        ...
                        <div class="modal-header">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="Noktp" placeholder="Masukkan No. KTP" name="noktp" required>
                                </div>
                                <div class="mb-3">
                                    <label for="Telepon" class="form-label">No. Telepon</label>
                                    <input type="text" class="form-control" id="Telepon" placeholder="Masukkan No. Telepon" name="telp" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="Selisih" placeholder="Selisih Masa Kerja" name="selisih" required>
                                </div>
                            </div>
    ...
    <div class="container mt-5">
      <table class="table table-striped" id="tabeldataktp">
        <thead>
          <tr>
            <th scope="col">No.</th>
